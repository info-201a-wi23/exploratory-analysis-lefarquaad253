...
map
```
We chose a map to represent the distribution of adoptable dogs across the United States because it provides a visualization of which states have a high and low concentration of dogs sitting in shelters. Based on the visualization, it appears that many states within the Rocky Mountain and Midwest regions have a lower volume of dogs sitting in shelters compared to more urbanized areas and states on the East Coast, such as New York, Georgia and Virginia. We can conclude that more urbanized and populated areas are likely to have a larger pool of potential adopters compared to rural areas. It is important to have relocation programs in place to ensure that dogs are better allocated to areas where they are more likely to find homes.
